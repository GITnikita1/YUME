...
<body>
    ...
    <header>
        <img src="/img/main_img.jpeg" alt="" width="100%">
    </header>
    ...
    <div class="spine">
        ...
        <div class="container3">
            <div class="phase1">
                <div class="order">
                    <h2>НЕТ ВРЕМЕНИ НА ЗАКАЗ?</h2>
                    <p>Оформи доставку в любую точку города*</p>
                    <p class="star">*в зависимости от расположения время заказа может измениться</p>
                    <div class="butn"><p>Узнать подробнее</p>
                </div>
                </div>
                <div class="burger"><img src="/main/burger_on_hand.jpg" alt="" width="100%" style="overflow: hidden;height:100%;"></div>
            </div>
    ...
    <div class="last_pre">
            <div class="left"><img src="/about_us/potato7.jpg" alt="potatoBlue" width="100%" height="100%"></div>
            <div class="right"><img src="/about_us/burgerParts.jpg" alt="burgerPink" width="100%" height="100%"></div>
    </div>
